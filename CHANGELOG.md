...
- **`tests/integration-test.sh`**
  - Added a scoped `# shellcheck disable=SC2329` directive on the `cleanup` function so ShellCheck no longer warns about the trap handler not being explicitly invoked.
